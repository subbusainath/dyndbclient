...
const read_1 = require("../operations/read");
const delete_1 = require("../operations/delete");
const scan_1 = require("../operations/scan");
const query_builder_1 = require("../operations/query-builder");
...
class DyndbClient {
    ...
    constructor(config) {
        try {
            ...
            (0, error_handler_1.handleError)('Failed to initialize DynamoDB client', error);
        }
    }
    /**
     ...
     */
    scan() {
        return new scan_builder_1.ScanBuilder();
    }
    /**
    ...
    async executeQuery(options) {
        try {
            return await (0, query_1.queryTable)(this.client, this.tableName, options);
        }
        catch (error) {
            return (0, error_handler_1.handleError)('Failed to execute query', error);
        }
    }
    /**
    ...
    async executeScan(options) {
        try {
            return await (0, scan_1.scanTable)(this.client, this.tableName, options);
        }
        catch (error) {
            return (0, error_handler_1.handleError)('Failed to execute scan', error);
        }
    }
    /**
     ...
     * }
     */
    async batchGet(requests, options) {
        try {
            const command = new lib_dynamodb_1.BatchGetCommand({
                RequestItems: requests.reduce((acc, req) => ({
                    ...acc,
                    [req.tableName]: {
                        Keys: req.keys,
            ...
            return {
                success: false,
                error: error instanceof Error ? error : new Error('Unknown error during batch get operation')
            };
        }
    }
    /**
     ...
     * }
     */
    async batchWrite(requests, options) {
        try {
            ...
            return {
                success: false,
                error: error instanceof Error ? error : new Error('Unknown error during batch write operation')
            };
        }
    }
    /**
    ...
    async executeTransaction(operations) {
        return (0, transaction_1.executeTransaction)(this.client, this.tableName, operations);
    }
    /**
     ...
     * }
     */
    async transactionGet(items) {
        return (0, transaction_1.transactionGet)(this.client, this.tableName, items);
    }
    /**
    ...
    async update(key, updates, options) {
        ...
        return (0, update_1.updateItem)(this.client, this.tableName, key, updateFields, updateOpts);
    }
    /**
    ...
    async create(item, options) {
        const createOpts = {
            ...options,
            returnValues: options?.returnValues === 'ALL_NEW' || options?.returnValues === 'UPDATED_OLD' || options?.returnValues === 'UPDATED_NEW' ? 'NONE' : options?.returnValues
        };
        return (0, create_1.createItem)(this.client, this.tableName, item, createOpts);
    }
    /**
    ...
    async read(key, options) {
        return (0, read_1.readItem)(this.client, this.tableName, key, options);
    }
    /**
    ...
    async delete(key, options) {
        const deleteOpts = {
            ...options,
            returnValues: options?.returnValues === 'UPDATED_OLD' || options?.returnValues === 'UPDATED_NEW' || options?.returnValues === 'ALL_NEW' ? 'ALL_OLD' : options?.returnValues
        };
        return (0, delete_1.deleteItem)(this.client, this.tableName, key, deleteOpts);
    }
    /**
    ...
    async getStreamArn() {
        try {
            ...
            const streamsClient = new client_dynamodb_streams_1.DynamoDBStreamsClient({
                region: this.client.config.region,
                endpoint: this.client.config.endpoint,
                credentials: this.client.config.credentials
            });
            return await (0, stream_1.getTableStreamArn)(streamsClient, this.tableName);
        }
        catch (error) {
            return (0, error_handler_1.handleError)('Failed to get stream ARN', error);
        }
    }
    /**
    ...
    async describeStream(streamArn) {
        try {
            ...
            return await (0, stream_1.describeStream)(streamsClient, streamArn);
        }
        catch (error) {
            return (0, error_handler_1.handleError)('Failed to describe stream', error);
        }
    }
    /**
     ...
     * }
     */
    async getStreamRecords(shardIterator, limit) {
        try {
            // Create a DynamoDB Streams client using the same configuration
            const streamsClient = new client_dynamodb_streams_1.DynamoDBStreamsClient({
                region: this.client.config.region,
            ...
            return await (0, stream_1.getStreamRecords)(streamsClient, shardIterator, limit);
        }
        catch (error) {
     ...
     * }
     */
    async getShardIterator(streamArn, shardId, iteratorType, sequenceNumber) {
        try {
            // Create a DynamoDB Streams client using the same configuration
            const streamsClient = new client_dynamodb_streams_1.DynamoDBStreamsClient({
                region: this.client.config.region,
            ...
            return await (0, stream_1.getShardIterator)(streamsClient, streamArn, shardId, iteratorType, sequenceNumber);
        }
        catch (error) {
            return (0, error_handler_1.handleError)('Failed to get shard iterator', error);
        }
    }
    /**
     ...
     * }
     */
    async processStream(streamArn, handler, config = {}) {
        try {
            // Create a DynamoDB Streams client using the same configuration
            const streamsClient = new client_dynamodb_streams_1.DynamoDBStreamsClient({
                region: this.client.config.region,
            ...
            await (0, stream_1.processStream)(streamsClient, streamArn, handler, config);
        }
        catch (error) {
            throw error;
        }
     ...
     * }
     */
    async startStreamProcessing(handler, options = {}, config = {}) {
        try {
...
exports.DyndbClient = DyndbClient;
